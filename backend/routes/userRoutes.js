...
const router = Router();
import {registerUser, autenticateUser, confirm, forgotPassword, resetPassword, perfil, confirmPassword} from '../controllers/usersControllers.js'
import checkAuth from '../middleware/checkAuth.js'

/* Publics */
router.post('/', registerUser); // Create a new user
router.post('/login', autenticateUser); // Autenticate user
router.get('/confirm/:token', confirmPassword); // Confirm user

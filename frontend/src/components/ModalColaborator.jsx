...
const ModalColaborator = () => {
  ...
  return (
    <Transition.Root show={modalDeleteColaborator} as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={handleModalColaborator}>
                    ...
                    >
                        <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className='h-12 w-12 flex items-center justify-center p-4 bg-red-200 rounded-full mx-auto'>
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <div className='mt-2'>
                                        <p className='text-sm text-gray-500'>Are you sure you want to delete to {colaborator.name} as colaborator?</p>
                                    </div>
                                </div>
                            </div>
                            <div
